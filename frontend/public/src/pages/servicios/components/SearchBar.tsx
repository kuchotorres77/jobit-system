...
import { Briefcase, ChevronDown, MapPin, Wrench } from "lucide-react";
  ...
  return (
    <div className="relative w-full sm:w-44" ref={ref}>
      ...
      >
        ...
        <span className={`flex-1 text-left text-sm truncate ${value ? "text-gray-800 font-medium" : "text-gray-400"}`}>
          {value || placeholder}
        </span>
...
export function SearchBar({ rubros, values, loading = false, onChange, onBuscar }: SearchBarProps) {
